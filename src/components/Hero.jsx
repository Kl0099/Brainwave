        ...
        <div className="   relative z-1 max-w-[62rem] mx-auto text-center mb-[4rem] md:mb-20 lg:mb-[6.25rem]">
          <h1 className="h1 mb-6">
            ...
            <span className=" inline-block relative">
              Brainwave{" "}
              <img
                className=" absolute top-full w-full xl:-mt-2 left-0"
                src={curve}
                width={624}
                height={28}
                alt="Curve"
          ...
          {/* a littelbit confusion between /pricong and #pricing */}
          <Button
            href={"/pricing"}
            white
          >
            ...
            <div className=" relative bg-n-8 rounded-[1rem]">
              ...
              <div className=" aspect-[33/40] rounded-b-[0.9rem] overflow-hidden md:aspect-[688/490] lg:aspect-[1024/490]">
                ...
                <ScrollParallax isAbsolutelyPositioned>
                  <ul className=" hidden absolute -left-[5.5rem] bottom-[7.5rem] bg-n-9/40 rounded-2xl xl:flex px-1 py-1 backdrop-blur border-n-1/10 ">
